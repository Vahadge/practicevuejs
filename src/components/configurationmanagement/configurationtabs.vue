...
<template>
  <div
    class="mt-10 text-lg font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700"
  >
    <ul class="flex flex-wrap -mb-px">
      ...
      <li  class="me-2" data-componentid="itemproductmapping" @click="setTab($event)">
        <a
          href="#"
          class="inline-block p-4  rounded-t-lg  dark:text-blue-500 dark:border-blue-500"
          :class="[currenttab == 'itemproductmapping' ? 'text-blue-600 border-b-2 border-blue-600 active' : '']"
          aria-current="page"
